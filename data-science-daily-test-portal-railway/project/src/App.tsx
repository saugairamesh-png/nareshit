            ...
            <div className="md:col-span-7 space-y-6 text-center md:text-left">
              <div className="space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl md:text-7xl font-serif font-black tracking-tight leading-none flex items-baseline justify-center md:justify-start gap-1">
                  <span className="bg-gradient-to-b from-red-600 to-red-700 bg-clip-text text-transparent">NARESH</span>
                  <span className="bg-gradient-to-b from-indigo-600 to-indigo-800 bg-clip-text text-transparent italic font-serif">i</span>
                </h1>
                <p className="italic font-serif font-semibold text-indigo-600 text-xl md:text-2xl -mt-1 tracking-wide">
                  technologies
                </p>
              ...
              <div className="h-1 w-20 bg-gradient-to-r from-red-600 to-indigo-600 mx-auto md:mx-0 rounded-full"></div>
