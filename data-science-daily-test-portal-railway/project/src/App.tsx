    ...
    <div className="bg-slate-50 min-h-screen flex flex-col justify-between text-slate-800 font-sans">
      ...
      <nav className="h-16 bg-slate-900 border-b border-slate-800 text-white flex justify-between items-center px-6 shadow-sm shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-indigo-600 rounded flex items-center justify-center font-bold text-lg font-display select-none">NIT</div>
          <div>
            ...
            <span className="text-[10px] text-indigo-400 font-mono leading-none font-semibold">Naresh IT Academy</span>
          </div>
        </div>
          ...
          <div className="max-w-5xl w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
            ...
            <div className="md:col-span-7 space-y-6 text-center md:text-left">
              <div className="space-y-2">
                ...
                <div className="inline-block bg-gradient-to-b from-yellow-400 to-yellow-500 rounded-2xl px-6 py-4 shadow-md">
                  <h1 className="text-5xl sm:text-6xl md:text-7xl font-serif font-black tracking-tight leading-none flex items-baseline justify-center md:justify-start gap-1">
                    <span className="text-red-600">NARESH</span>
                    <span className="text-blue-700 italic font-serif">i</span>
                  </h1>
                  <p className="italic font-serif font-bold text-teal-700 text-xl md:text-2xl -mt-1 tracking-wide">
                    technologies
                  </p>
                </div>
                <p className="text-sm md:text-base font-extrabold text-slate-650 font-display tracking-tight mt-2 uppercase text-indigo-600">
                  Data Science & Machine Learning Academy
                </p>
              </div>
              
              <div className="h-1 w-20 bg-gradient-to-r from-red-600 to-teal-600 mx-auto md:mx-0 rounded-full"></div>
            ...
            <div className="md:col-span-5 bg-white rounded-3xl shadow-xl border border-slate-200 p-8 space-y-6">
              ...
              <div className="text-center pt-2">
                <span className="text-[10px] text-slate-400 font-mono font-medium">
                  Naresh IT Elite Data Science Program
                </span>
              </div>
            </div>
          </div>
