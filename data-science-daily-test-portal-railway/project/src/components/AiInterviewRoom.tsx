        ...
        <div className="bg-slate-900 text-white p-3 border-b border-slate-800 flex items-center justify-between gap-3 shrink-0">
          <div className="flex items-center gap-3">
            <div className="relative w-12 h-12 shrink-0">
              ...
              <div className="relative w-12 h-12 bg-slate-950 rounded-xl border border-indigo-500/40 flex items-center justify-center overflow-hidden shadow-md">
                ...
                <img 
                  ...
                  className={`w-full h-full object-cover relative z-10 transition-transform duration-500 ${
                    isLoadingMessage ? "scale-105 contrast-110" : isRecordingVoice ? "scale-110 brightness-110" : isAiSpeaking ? "scale-110 brightness-110" : ""
                  }`} 
                  style={isAiSpeaking ? { animation: "aiTalkBob 0.5s ease-in-out infinite" } : undefined}
                />
              ...
              <style>{`
                @keyframes aiTalkBob {
                  ...
                  50% { transform: scale(1.11) translateY(-1px); }
                }
              `}</style>
            </div>
            <div>
